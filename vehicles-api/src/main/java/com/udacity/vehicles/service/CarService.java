...
public class CarService {
    ...
    public Car findById(Long id) {
        ...
        if (car.isPresent()) {
            Car entity = car.get();
            entity.setPrice(priceClient.getPrice(id));
            entity.setLocation(mapsClient.getAddress(entity.getLocation()));
            return entity;
        } else {
            throw new CarNotFoundException("Car not found, please try again!");
        }
